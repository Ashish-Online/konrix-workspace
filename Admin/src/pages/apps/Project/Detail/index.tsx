  ...
  return (
    <div className="lg:col-span-2">
      <div className="card">
        ...
        <div className="p-6">
          <div>
            <p className="text-gray-500 mb-4 text-sm">To an English person, it will seem like simplified English, as a skeptical Cambridge friend of mine told me what Occidental is.</p>
            <p className="text-gray-500 mb-4 text-sm">Everyone realizes why a new common language would be desirable: one could refuse to pay expensive translators.</p>
