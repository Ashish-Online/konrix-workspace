...
function useAptor(ref, configuration, deps = []) {
  ...
  const api = (0, import_react.useMemo)(() => getAPI2(instance, params), [instance]);
...
var instantiate = (_, params) => {
  const plyr = new Plyr(".plyr-react", params.options || {});
  if (params.source)
...
var Plyr2 = React.forwardRef((props, ref) => {
  const { source: source2, options = null, ...rest } = props;
  const raptorRef = usePlyr(ref, {
    source: source2,
    options
  });
  return (0, import_jsx_runtime.jsx)("video", { ref: raptorRef, className: "plyr-react plyr", ...rest });
});
if ((import.meta.env && import.meta.env.MODE) !== "production") {
  Plyr2.displayName = "Plyr";
  Plyr2.defaultProps = {
    options: {
      controls: [
        "rewind",
...
react/cjs/react-jsx-runtime.development.js:
   ...
   *)
*/
//# sourceMappingURL=plyr-react.js.map
