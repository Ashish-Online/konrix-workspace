...
function findLastIndex(array, predicate, fromIndex) {
  ...
  if (fromIndex !== void 0) {
    ...
    index = fromIndex < 0 ? nativeMax6(length + index, 0) : nativeMin4(index, length - 1);
  }
...
function baseInRange(number, start, end) {
  return number >= nativeMin5(start, end) && number < nativeMax7(start, end);
}
...
function includes(collection, value, fromIndex, guard) {
  ...
  if (fromIndex < 0) {
    fromIndex = nativeMax8(length + fromIndex, 0);
  }
...
function indexOf(array, value, fromIndex) {
  ...
  var index = fromIndex == null ? 0 : toInteger_default(fromIndex);
  if (index < 0) {
    index = nativeMax9(length + index, 0);
  }
...
function lastIndexOf(array, value, fromIndex) {
  ...
  if (fromIndex !== void 0) {
    index = toInteger_default(fromIndex);
    index = index < 0 ? nativeMax10(length + index, 0) : nativeMin7(index, length - 1);
  }
...
function baseRange(start, end, step, fromRight) {
  var index = -1, length = nativeMax11(nativeCeil4((end - start) / (step || 1)), 0), result2 = Array(length);
  while (length--) {
...
function spread(func, start) {
  ...
  start = start == null ? 0 : nativeMax12(toInteger_default(start), 0);
  return baseRest_default(function(args) {
...
function unzip(array) {
  ...
  array = arrayFilter_default(array, function(group) {
    if (isArrayLikeObject_default(group)) {
      length = nativeMax13(group.length, length);
      return true;
    }
  });
  ...
  while (++index < length) {
    ...
    switch (data.type) {
      ...
      case "take":
        ...
        break;
      case "takeRight":
        start = nativeMax14(start, end - size2);
        break;
    }
  }
...
arrayEach_default(["drop", "take"], function(methodName, index) {
  LazyWrapper_default.prototype[methodName] = function(n) {
    n = n === void 0 ? 1 : nativeMax15(toInteger_default(n), 0);
